...
\begin{flushleft}
    ...
    \textbf{ better relationship} only transitive 
    ...
    \textbf{ better or equal relationship} transitive and reflective 
    ...
    $GLB$ for better or equal relationship does not exist because $A$ is not related to $AEG$
